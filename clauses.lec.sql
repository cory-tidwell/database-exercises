...
SELECT DISTINCT hire_date, birth_date FROM employees WHERE hire_date LIKE '1985%' ORDER BY hire_date DESC, birth_date ASC;
...
SELECT first_name, last_name FROM employees WHERE first_name = 'Munenori'
LIMIT 9 OFFSET 17;

USE codeup_test_db;

INSERT INTO quotes (author_first_name, author_last_name, content) VALUES ('David', 'Stephens', '99 bottles of root beer on the wall...');

SELECT * FROM quotes ORDER BY content;